...
const transactionsSlice = createSlice({
    ...
    initialState,
    reducers: {
        // addTransaction will dispatch object like { category, description, amount, id}
        addTransaction: (state, action) => {
            const category = action.payload.category
            let newTransactionsForCategory = [...state[category].slice(), action.payload]
            return { ...state, [category]: newTransactionsForCategory }
        },
